...
export default function Dialog({title, onClose, onOk, children, popupVisible}: Props) {
// export default function Dialog({title, onClose, onOk, popupVisible}: Props) {
  ...
  const dialog: JSX.Element | null = popupVisible
  ?(
      ...
      <div className="w-[500px] max-w-fullbg-gray-200 flex flex-col">
        ...
        <div className="px-5 pb-6">
          ...
          {/* <div className="flex flex-row justify-end mt-2">
            <button onClick={clickOk} className="bg-green-500 py-1 px-2 rounded border-none">
              OK
            </button>
          </div> */}
        </div>
